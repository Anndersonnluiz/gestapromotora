...
public class HistoricoContratoMB implements Serializable {
  ...
  public void gerarListaContrato() {
    ...
    String sql = "Select c From Historicocomissao c WHERE c.contrato.cliente.idcliente=" + this.cliente.getIdcliente();
  ...
  public void pesquisar() {
    ...
    if (this.tipooiperacao != null && this.tipooiperacao.getIdtipooperacao() != null)
      sql = String.valueOf(sql) + " and c.contrato.tipooperacao.idtipooperacao=" + this.tipooiperacao.getIdtipooperacao(); 
