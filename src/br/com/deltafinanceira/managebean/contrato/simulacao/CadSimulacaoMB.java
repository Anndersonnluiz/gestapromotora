...
public class CadSimulacaoMB implements Serializable {
  ...
  public void calculoParcelas() {
    if (this.simulacaocontrato.getContrato().getParcelaspagas() > 0.0D && this.simulacaocontrato.getContrato().getTotalparcelas() > 0.0D) {
      this.simulacaocontrato.getContrato().setPercentualpago((this.simulacaocontrato.getContrato().getParcelaspagas() * 100 / this.simulacaocontrato.getContrato().getTotalparcelas()));
      this.simulacaocontrato.getContrato().setParcelasrestantes(this.simulacaocontrato.getContrato().getTotalparcelas() - this.simulacaocontrato.getContrato().getParcelaspagas());
    } 
  }
  ...
  public String salvar() {
    ...
    if (this.simulacaocontrato.getContrato() == null || this.simulacaocontrato.getContrato().getIdcontrato() == null) {
      this.simulacaocontrato.getContrato().setUsuario(this.usuario);
      this.simulacaocontrato.getContrato().setSimulacao(true);
      if (this.simulacaocontrato.getContrato().getBanco() == null || this.simulacaocontrato.getContrato().getBanco().getIdbanco() == null)
