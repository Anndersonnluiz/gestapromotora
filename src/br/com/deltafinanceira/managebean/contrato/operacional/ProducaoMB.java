...
public class ProducaoMB implements Serializable {
	...
	public void gerarListaInicial() {
		...
		String sql = "Select h From Historicocomissao h WHERE h.tipo='PENDENTE' and h.contrato.situacao.idsituacao<>2"
				+ " and h.contrato.ultimamudancasituacao>='2020-11-01' and h.baixa=false and h.contrato.simulacao=false";
		if (!usuarioLogadoMB.getUsuario().isAcessogeral() && usuarioLogadoMB.getUsuario().isResponsaveldepartamento()) {
			sql = sql + " and h.contrato.usuario.departamento.iddepartamento=7";
		}
	...
	public void pesquisar() {
		String sql = "Select h From Historicocomissao h Where h.contrato.situacao.idsituacao<>2 and h.contrato.simulacao=false";
	...
	public void gerarListaUsuario() {
		...
		sql = sql + " and u.departamento.iddepartamento=7";
