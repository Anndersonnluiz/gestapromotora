...
public class ProducaoMB implements Serializable {
  ...
  public void gerarListaInicial() {
    ...
    if (!this.usuarioLogadoMB.getUsuario().isAcessogeral() && this.usuarioLogadoMB.getUsuario().isResponsaveldepartamento())
    ...
    for (int i = 0; i < this.listaComissao.size(); i++) {
      if (((Historicocomissao)this.listaComissao.get(i)).getContrato().getTipooperacao().getIdtipooperacao().intValue() == 1) {
        this.nPortabilidade++;
        this.valorPortabilidade += ((Historicocomissao)this.listaComissao.get(i)).getProdliq();
      } else if (((Historicocomissao)this.listaComissao.get(i)).getContrato().getTipooperacao().getIdtipooperacao().intValue() == 2) {
        this.nMargem++;
        this.valorMargem += ((Historicocomissao)this.listaComissao.get(i)).getProdliq();
      } else if (((Historicocomissao)this.listaComissao.get(i)).getContrato().getTipooperacao().getIdtipooperacao().intValue() == 7 || (
        (Historicocomissao)this.listaComissao.get(i)).getContrato().getTipooperacao().getIdtipooperacao().intValue() == 8 || (
        (Historicocomissao)this.listaComissao.get(i)).getContrato().getTipooperacao().getIdtipooperacao().intValue() == 9) {
        this.nRefin++;
        this.valorRefin += ((Historicocomissao)this.listaComissao.get(i)).getProdliq();
      } else if (((Historicocomissao)this.listaComissao.get(i)).getContrato().getTipooperacao().getIdtipooperacao().intValue() == 3 || (
        (Historicocomissao)this.listaComissao.get(i)).getContrato().getTipooperacao().getIdtipooperacao().intValue() == 4 || (
        (Historicocomissao)this.listaComissao.get(i)).getContrato().getTipooperacao().getIdtipooperacao().intValue() == 5) {
        this.nCartao++;
  ...
  public void pesquisar() {
    String sql = "Select h From Historicocomissao h Where h.contrato.situacao.idsituacao<>2 and h.contrato.simulacao=false and h.contrato.cliente.nome like '%" + 
      this.nomecliente + 
      "%' and h.contrato.cliente.cpf like '%" + this.cpf + "%'";
    if (this.tipooiperacao != null && this.tipooiperacao.getIdtipooperacao() != null)
      sql = String.valueOf(sql) + " and h.contrato.tipooperacao.idtipooperacao=" + this.tipooiperacao.getIdtipooperacao(); 
    ...
    if (this.dataini != null && this.datafin != null)
      sql = String.valueOf(sql) + " and h.contrato.ultimamudancasituacao>='" + Formatacao.ConvercaoDataNfe(this.dataini) + 
        "' and h.contrato.ultimamudancasituacao<='" + Formatacao.ConvercaoDataNfe(this.datafin) + "'"; 
    if (this.dataCadastroIni != null && this.dataCadastroFinal != null)
      sql = String.valueOf(sql) + " and h.contrato.datacadastro>='" + Formatacao.ConvercaoDataNfe(this.dataCadastroIni) + "'" + 
        " and h.contrato.datacadastro<='" + Formatacao.ConvercaoDataNfe(this.dataCadastroFinal) + "'"; 
    if (this.situacao > 0)
      if (this.situacao == 1) {
  ...
  public String relatorioGeral(boolean selecionarTodos) {
    ...
    String periodo = "";
    if (this.dataCadastroIni != null && this.dataCadastroFinal != null) {
      periodo = String.valueOf(Formatacao.ConvercaoDataPadrao(this.dataCadastroIni)) + " a " + Formatacao.ConvercaoDataPadrao(this.dataCadastroFinal);
    } else {
      periodo = "Sem Periodo";
    } 
