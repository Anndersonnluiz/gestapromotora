...
public class DemaisOperacoesMB implements Serializable {
	...
	public void gerarListaDemaisOperacoes(int situacao) {
		...
		String sql = "Select c From Contrato c WHERE c.tipooperacao.descricao not like '%Portabilidade%' and c.operacaoinss=false and c.simulacao=false";
		if (situacao > 0)
	...
	public void pesquisar() {
		String sql = "Select c From Contrato c WHERE c.tipooperacao.descricao not like '%Portabilidade%' and c.cliente.nome like '%"
	...
	public void gerarListaInicial() {
		...
		String sql = "Select c From Contrato c WHERE c.tipooperacao.descricao not like '%Portabilidade%' "
				+ "and c.operacaoinss=false and c.simulacao=false  and c.ultimamudancasituacao>='2021-01-01'";
