...
public class PortabilidadeMB implements Serializable{
	...
	public int getnAguardandoFormalizacaoCIP() {
		return nAguardandoFormalizacaoCIP;
	}
	...
	public void gerarListaInicial() {
		...
		for (int i = 0; i < listaContratoPesquisa.size(); i++) {
			...
			}else if(listaContratoPesquisa.get(i).getSituacao().getIdsituacao() == 38) {
				nAguardandoFormalizacaoCIP = nAguardandoFormalizacaoCIP + 1;
			}
		}
	}
