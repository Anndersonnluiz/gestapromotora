...
public class Contrato implements Serializable {
	...
	@Column(name = "saldoquitado")
	private float saldoquitado;
	...
	/**
	 * @return the saldoquitado
	 */
	public float getSaldoquitado() {
		return saldoquitado;
	}

	/**
	 * @param saldoquitado the saldoquitado to set
	 */
	public void setSaldoquitado(float saldoquitado) {
		this.saldoquitado = saldoquitado;
	}
